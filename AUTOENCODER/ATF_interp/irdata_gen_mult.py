...
from src.utils import dim2cuboid
...
if __name__ == "__main__":
    ...
    irlen = 256#1024#2048#4096  # IR length
    ...
    irlen_algn = 128#512 # IR length for time-alignment
    ...
    for i in range(num_src):
        ...
        # Save data
        np.savez(f"{dir}data_s{i+1:04d}.npz", rir, atf, atf_mag, rir_algn, atf_algn, atf_mag_algn, posSrc[i,:], posMic)
